...
import { getRemoteClient } from '@shared/storage/DirectObjectStoreClient';
import type { FilesystemObjectStore } from '@shared/storage/FilesystemObjectStore';
import type { DirectObjectStoreClient } from '@shared/storage/DirectObjectStoreClient';
...
const createClusterObjectStore = (
    ...
    remoteClient: DirectObjectStoreClient
): ClusterObjectStore => {
