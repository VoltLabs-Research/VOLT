...
import { WebSocketSessionManager } from '@modules/system/services/sessions/WebSocketSessionManager';
import { TunnelSessionManager, type TunnelMessageTransport } from '@modules/system/services/sessions/TunnelSessionManager';
import { createReverseChannelCommandHandler } from '@modules/system/socket/reverse-channel-command-handler';
...
import type { SessionTransition } from '@modules/system/services/sessions/session-transitions';
...
export class ReverseChannelBridge {
    ...
    constructor(daemonExposureRegistry: DaemonExposureRegistry) {
        const coordinator = {
...
export const getReverseChannelBridge = singleton((): ReverseChannelBridge => new ReverseChannelBridge(getDaemonExposureRegistry()));
