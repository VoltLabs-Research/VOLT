...
const Slider: React.FC<SliderProps> = ({
    ...
    return (
        <div className={`slider slider--ios ${disabled ? 'slider--disabled' : ''} ${className || ''} u-select-none`} style={style} aria-disabled={disabled || undefined} data-disabled={disabled || undefined}>
            ...
            >
                <div ref={progressRef} className='slider__progress p-absolute inset-0'>
                    <div className='slider__gloss p-absolute' />
                    <div ref={sheenRef} className='slider__sheen p-absolute' />
                    <div ref={auraRef} className='slider__aura p-absolute' />
