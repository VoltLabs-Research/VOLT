...
import { ICON_COMPONENT_ENTRIES } from '@/shared/ui/components/DynamicIcon/loaders';
import { ChevronDown, Search } from 'lucide-react';
import { useId, useMemo, useState } from 'react';
import './IconPicker.css';

const DEFAULT_PAGE_SIZE = 20;
const FILTERED_PAGE_SIZE = 40;
...
const IconPickerPanel = ({ value, onChange, close }: IconPickerPanelProps) => {
    ...
    const matches = useMemo(() => {
        ...
        if (!q) return ICON_COMPONENT_ENTRIES.slice(0, DEFAULT_PAGE_SIZE);
        return ICON_COMPONENT_ENTRIES
