...
import { ANIMATION_CONSTANTS, ensureSimulationBox, startSizeAnimAfterRotation, runSizeAnimationStep } from '@/features/canvas/utilities/simulation-box';
...
export default class AnimationController {
    ...
    private updateSimulationBox(): void {
        ...
        // If the simulation box is managed externally (e.g. via React), do not update it here.
