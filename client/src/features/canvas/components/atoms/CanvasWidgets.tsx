...
import EditorSidebar from '@/features/canvas/components/organisms/EditorSidebar';
import TrajectoryVisibilityStatusFloatIcon from '@/features/canvas/components/atoms/TrajectoryVisibilityStatusFloatIcon';
import SceneTopCenteredOptions from '@/features/canvas/components/atoms/SceneTopCenteredOptions';
import SlicePlane from '@/features/canvas/components/organisms/SlicePlane';
import TimestepControls from '@/features/canvas/components/organisms/TimestepControls';
...
import PluginResultsViewer from '@/features/canvas/components/organisms/PluginResultsViewer';
...
import ColorCoding from '@/features/canvas/components/organisms/ColorCoding';
import ParticleFilter from '@/features/canvas/components/organisms/ParticleFilter';
import PerformanceMonitor from '@/features/canvas/components/organisms/PerformanceMonitor';
