...
const ContainerMetricTile = ({
    ...
    return (
        <Container className={`container-metric-tile d-flex column gap-05 ${stateClass}`}>
            <Container className='d-flex items-baseline content-between gap-05'>
            ...
            <Container className='container-metric-tile-sparkline' aria-hidden='true'>
            ...
            {secondary && secondary.length > 0 && (
                <Container className='container-metric-tile-secondary d-flex items-center flex-wrap'>
