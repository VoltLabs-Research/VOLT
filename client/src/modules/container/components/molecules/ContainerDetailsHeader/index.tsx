...
const ContainerDetailsHeader = ({
    ...
    return (
        <Container className='container-details-header d-flex column'>
            ...
            <Container className='container-details-header-top d-flex items-start content-between mt-05'>
                <Container className='container-details-header-identity d-flex column gap-025'>
                    <Container className='d-flex items-center gap-075 flex-wrap'>
                        <Title as='h1' className='container-details-header-name font-size-4 font-weight-6'>
                            {container.name}
                        </Title>
                        <span
                    ...
                    <Container className='container-details-header-meta d-flex items-center flex-wrap'>
            ...
            <Container className='container-details-header-tabs-row d-flex'>
