...
const ClusterResourceSelectionPanel = ({
    ...
    return (
        <Container className='cluster-resource-selection-grid'>
            <Container className='cluster-resource-selection-card radius-md d-flex column gap-1 p-1-5'>
            ...
            <Container className='cluster-resource-selection-card radius-md d-flex column gap-1 p-1-5'>
                ...
                {!selectedTeamClusterId ? (
                    ...
                    <>
                        ...
                        <Container className='cluster-resource-selection-row radius-sm p-1 mb-075'>
                            <Container className='d-flex content-between items-center mb-075'>
                        ...
                        <Container className='cluster-resource-selection-row radius-sm p-1'>
                            <Container className='d-flex content-between items-center mb-075'>
                                <span className='d-flex items-center gap-05 font-size-2 font-weight-5 color-secondary'>
