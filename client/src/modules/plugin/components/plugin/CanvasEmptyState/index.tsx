...
const CanvasEmptyState = () => {
    ...
    return (
        <div className='volt-container p-absolute inset-0 d-flex flex-center z-10 canvas-empty-state'>
            <div className='volt-container d-flex column items-center gap-1 text-center canvas-empty-state-card glass-bg'>
                <div className='volt-container d-flex flex-center radius-md canvas-empty-state-icon-wrapper'>
                    <PlugZap size={28} />
                </div>

                <div className='volt-container d-flex column gap-05 items-center'>
                    <h3 className='volt-title font-size-4 font-weight-6'>
                        Start building your plugin
                    </h3>
                    <p className='volt-text color-secondary font-size-2 line-height-5 canvas-empty-state-description'>
                ...
                <div className='volt-container w-max d-flex items-center content-center flex-wrap gap-025 canvas-empty-state-flow'>
