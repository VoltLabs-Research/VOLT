...
import useDebugTrajectorySelector from '@/modules/plugin/hooks/use-debug-trajectory-selector';
...
import DebugArgumentsPanel from '@/modules/plugin/components/molecules/DebugArgumentsPanel';
