...
/**
 * Turns the column descriptors the listing endpoint reports in `_meta` into
 * table columns, dropping the trajectory column when the caller already scopes
 * the listing to a single trajectory.
 */
