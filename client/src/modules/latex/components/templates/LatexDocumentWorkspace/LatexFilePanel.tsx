                    ...
                    <ContextMenuPopover
                        ...
                        trigger={(
                            ...
                            >
                                ...
                                {isWorkspaceEmpty && (
                                    <Container className='latex-workspace__tree-empty-state d-flex column items-center content-center gap-05'>
                                        <Paragraph className='color-primary'>No files yet</Paragraph>
                                        <Paragraph className='latex-workspace__tree-empty-copy color-muted'>
