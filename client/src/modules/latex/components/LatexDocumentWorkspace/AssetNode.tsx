...
const AssetNode = ({ node, depth, onAssetDelete, onAssetInsertRef }: AssetNodeProps) => {
    ...
    return (
        <div className='volt-container latex-workspace__asset-row d-flex items-center content-between gap-05' style={{ paddingLeft: `${0.75 + indent / 16}rem` }}>
            ...
            <div className='volt-container d-flex items-center gap-025 f-shrink-0'>
