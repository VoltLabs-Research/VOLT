...
const FolderNode = ({
    ...
    return (
        <>
            <div className='volt-container latex-tree__folder-row d-flex items-center content-between gap-05' style={{ paddingLeft: `${0.5 + indent / 16}rem` }} onClick={handleToggle}>
