const ThinkingBubble = () => (
    <div className='min-w-0 max-w-full overflow-hidden rounded-xl px-4 py-3 leading-[1.55] whitespace-normal border-none bg-transparent pl-0 text-foreground min-h-[1.8rem]'>
