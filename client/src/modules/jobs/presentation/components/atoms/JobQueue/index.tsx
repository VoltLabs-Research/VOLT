...
const statusConfig = {
    completed: { icon: <IoCheckmark /> },
    running: { icon: <UseAnimations animation={activity} /> },
    queued: { icon: <IoTimeOutline /> },
    retrying: { icon: <CiRedo /> },
    queued_after_failure: { icon: <IoWarningOutline /> },
    failed: { icon: <IoCloseOutline /> },
    unknown: { icon: <IoWarningOutline /> }
} as const;
