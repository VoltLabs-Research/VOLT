...
import { updateSocketAuthToken } from '@/modules/socket/hooks/use-auth';
...
import type { CheckEmailOutputDTO } from '../api/dtos/check-email';
...
export const useCheckEmailMutation = (options?: MutationOptions<CheckEmailOutputDTO, { email: string }>) => {
    return useMutation({
        ...options,
