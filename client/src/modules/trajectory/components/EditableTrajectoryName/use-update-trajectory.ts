import { trajectoryQuery, TRAJECTORY_QUERY_KEYS } from '@/modules/trajectory/hooks/trajectory/queries';
...
export default function useUpdateTrajectory() {
    ...
    const updateTrajectory = useCallback(async (_id: string, data: UpdateTrajectoryInput) => {
        try {
