...
import type { PresenceUser } from '@/modules/socket/api/entities/presence-user';
import { SOCKET_TRAJECTORY_PRESENCE_EVENTS } from '@/modules/socket/api/entities/socket-constants';
