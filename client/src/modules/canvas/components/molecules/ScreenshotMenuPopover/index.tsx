...
const ScreenshotMenuPanel = ({ close }: { close: () => void }) => {
    ...
    return (
        <Container className='canvas-screenshot-popover d-flex column gap-075'>
            <Container className='canvas-screenshot-popover-fields d-flex column gap-05'>
                <FormFieldRHF
                ...
                {draft.resolutionPreset === 'custom' && (
                    <Container className='canvas-screenshot-popover-custom-size d-flex gap-05'>
                        <FormFieldRHF
            ...
            <Container className='canvas-screenshot-popover-summary d-flex column gap-025'>
