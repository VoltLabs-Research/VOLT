...
const LocalViewerFrameControls = ({
    ...
    return (
        <div className='absolute bottom-0 left-0 right-auto z-20 flex h-auto max-h-[calc(100%-2rem)] min-h-0 flex-col overflow-visible w-auto max-w-[min(44rem,calc(100%-1.5rem))] rounded-tr-xl bg-surface-secondary px-4 py-3.5 max-md:pointer-events-none max-md:inset-x-0 max-md:bottom-4 max-md:z-[120] max-md:w-full max-md:max-w-none max-md:rounded-b-xl max-md:rounded-t-none max-md:bg-transparent max-md:px-3.5 max-md:pt-3 max-md:pb-[calc(0.875rem_+_env(safe-area-inset-bottom,0px))]' id='canvas-center-timeline'>
