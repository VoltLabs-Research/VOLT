...
const TEAM_CLUSTER_REMOTE_ACCESS_LABELS: Record<TeamClusterRemoteAccessTarget, string> = {
    [TeamClusterRemoteAccessTarget.HostTerminal]: 'Open terminal',
...
const TEAM_CLUSTER_REMOTE_ACCESS_DESCRIPTIONS: Record<TeamClusterRemoteAccessTarget, string> = {
    [TeamClusterRemoteAccessTarget.HostTerminal]: 'Confirm your password to open an interactive shell on the selected cluster host.',
