...
export const ErrorCodes = createErrorCodes({
    ...
    LATEX_ASSET_STORAGE_KEY_FORBIDDEN: 'LatexAsset::StorageKeyForbidden',
    LATEX_ASSET_STORAGE_KEY_REQUIRED: 'LatexAsset::StorageKeyRequired',
    LATEX_DOCUMENT_STORAGE_CLUSTER_REQUIRED: 'LatexDocument::StorageClusterRequired',
