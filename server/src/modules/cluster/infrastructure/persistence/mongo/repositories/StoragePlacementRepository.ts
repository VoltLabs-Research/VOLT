...
import StoragePlacementModel, { StoragePlacementDocument } from '@modules/cluster/infrastructure/persistence/mongo/models/StoragePlacementModel';
...
export default class StoragePlacementRepository
    ...
    implements IStoragePlacementRepository {
