...
import type AuthService from '@modules/auth/application/AuthService';
import type { CheckEmailInputDTO } from '@modules/auth/application/dtos/CheckEmailDTO';
import type { DeleteAccountInputDTO } from '@modules/auth/application/dtos/DeleteAccountDTO';
import type { GetGuestIdentityInputDTO } from '@modules/auth/application/dtos/GetGuestIdentityDTO';
import type { GetMyAccountInputDTO } from '@modules/auth/application/dtos/GetMyAccountDTO';
import type { GetPasswordInfoInputDTO } from '@modules/auth/application/dtos/GetPasswordInfoDTO';
import type { SignInInputDTO } from '@modules/auth/application/dtos/SignInDTO';
import type { SignUpInputDTO } from '@modules/auth/application/dtos/SignUpDTO';
import type { UpdateAccountInputDTO } from '@modules/auth/application/dtos/UpdateAccountDTO';
import type { UpdatePasswordInputDTO } from '@modules/auth/application/dtos/UpdatePasswordDTO';
import type { LocalSignInInput } from '@modules/auth/application/AuthService';
