...
import type { CheckEmailInputDTO, CheckEmailOutputDTO } from '@modules/auth/application/dtos/CheckEmailDTO';
import type { DeleteAccountInputDTO, DeleteAccountOutputDTO } from '@modules/auth/application/dtos/DeleteAccountDTO';
import type { GetGuestIdentityInputDTO, GetGuestIdentityOutputDTO } from '@modules/auth/application/dtos/GetGuestIdentityDTO';
import type { GetMyAccountInputDTO, GetMyAccountOutputDTO } from '@modules/auth/application/dtos/GetMyAccountDTO';
import type { GetPasswordInfoInputDTO, GetPasswordInfoOutputDTO } from '@modules/auth/application/dtos/GetPasswordInfoDTO';
import { toPersistedUserDTO } from '@modules/auth/application/dtos/PersistedUserDTO';
import type { SignInInputDTO, SignInOutputDTO } from '@modules/auth/application/dtos/SignInDTO';
import type { SignUpInputDTO, SignUpOutputDTO } from '@modules/auth/application/dtos/SignUpDTO';
import type { UpdateAccountInputDTO, UpdateAccountOutputDTO } from '@modules/auth/application/dtos/UpdateAccountDTO';
import type { UpdatePasswordInputDTO, UpdatePasswordOutputDTO } from '@modules/auth/application/dtos/UpdatePasswordDTO';
import UpdateAccountUseCase from '@modules/auth/application/use-cases/UpdateAccountUseCase';
import User, { OAuthProvider, UserRole } from '@modules/auth/domain/entities/User';
