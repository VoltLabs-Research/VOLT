...
export default createHttpModule({
    ...
    routes: (router) => {
        ...
        router.get('/listing-rows/analyses/:analysisId/export', listingRowValidation.exportListingRowsByAnalysisId, controllers.exportListingRowsByAnalysisId.handle);
        ...
        router.get('/:pluginId/listing-rows/export', listingRowValidation.exportPluginListingDocuments, controllers.exportPluginListingDocuments.handle);
        ...
        router.get('/:pluginId/listing-rows/trajectories/:trajectoryId/export', listingRowValidation.exportPluginTrajectoryListingDocuments, controllers.exportPluginListingDocuments.handle);
