...
} from '@modules/plugin/dtos/exposure/GetPluginExposureExportDTO';
...
import type { IPluginExposureExportService } from '@modules/plugin/ports/exposure/IPluginExposureExportService';
