import { CommitBinaryUploadInputDTO } from '@modules/plugin/dtos/plugin/UploadBinaryDTO';
import type { BinaryUploadResult, IPluginStorageService } from '@modules/plugin/ports/plugin/IPluginStorageService';
