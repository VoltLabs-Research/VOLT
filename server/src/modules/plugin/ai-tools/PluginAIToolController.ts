...
import {
    comparePluginsSchema,
    executePipelineSchema,
    exportAnalysisResultSchema,
    getSubListingSchema,
    installPluginSchema,
    listAnalysisResultOptionsSchema,
    listPluginListingDocumentsSchema,
    listPluginsSchema,
    pluginRefSchema,
    readAnalysisResultRowsSchema,
    searchRegistryPluginsSchema,
    summarizeAnalysisResultSchema,
    uninstallPluginSchema,
    validateWorkflowSchema,
    type ComparePluginsInput,
    type ExecutePipelineInput,
    type ExportAnalysisResultInput,
    type GetSubListingInput,
    type InstallPluginInput,
    type ListAnalysisResultOptionsInput,
    type ListPluginListingDocumentsInput,
    type ListPluginsInput,
    type PluginRefInput,
    type ReadAnalysisResultRowsInput,
    type SearchRegistryPluginsInput,
...
export default class PluginAIToolController extends AIToolController {
    ...
    @AITool({
        ...
        parameters: installPluginSchema
    })
    ...
    @AITool({
        ...
        parameters: searchRegistryPluginsSchema
    })
    ...
    async listPlugins(input: ListPluginsInput & AIToolScope) {
        const { total, data } = await this.#service.listPlugins(input);
    ...
    @AITool({
        ...
        parameters: comparePluginsSchema
    })
    ...
    @AITool({
        ...
        parameters: uninstallPluginSchema
    })
    ...
    @AITool({
        ...
        parameters: executePipelineSchema,
        needsApproval: true
    })
    ...
    @AITool({
        ...
        parameters: listPluginListingDocumentsSchema
    })
    ...
    @AITool({
        ...
        parameters: listAnalysisResultOptionsSchema
    })
    ...
    @AITool({
        ...
        parameters: readAnalysisResultRowsSchema
    })
    ...
    @AITool({
        ...
        parameters: getSubListingSchema
    })
    ...
    @AITool({
        ...
        parameters: summarizeAnalysisResultSchema
    })
    ...
    @AITool({
        ...
        parameters: exportAnalysisResultSchema
    })
