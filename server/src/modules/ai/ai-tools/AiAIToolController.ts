...
import {
    configureColorCodingSchema,
    controlPlaybackSchema,
    deleteConversationSchema,
    focusResultSchema,
    launchGrainSegmentationAnalysisSchema,
    listConversationsSchema,
    navigateToSchema,
    noParamsSchema,
    openCommandPaletteSchema,
    openInViewerSchema,
    openPanelSchema,
    pushExpressionSelectSchema,
    resetViewSettingsSchema,
    seekFrameSchema,
    setAppearanceSchema,
    setCameraViewSchema,
    setChatSurfaceSchema,
...
export default class AiAIToolController extends AIToolController {
    ...
    @AITool({
        ...
        parameters: updateConversationSchema
    })
    ...
    @ClientAITool({
        ...
        parameters: openCommandPaletteSchema
    })
    ...
    @ClientAITool({
        ...
        parameters: setChatSurfaceSchema
    })
    setChatSurface(): void {}
    ...
    @ClientAITool({
        ...
        parameters: setCameraViewSchema
    })
    setCameraView(): void {}
    ...
    @ClientAITool({
        ...
        parameters: setAppearanceSchema
    })
    setAppearance(): void {}
    ...
    @ClientAITool({
        ...
        parameters: setEnvironmentSchema
    })
    setEnvironment(): void {}
    ...
    @ClientAITool({
        ...
        parameters: setVisibleLayersSchema
    })
    ...
    @ClientAITool({
        ...
        description: 'Undo or redo the last viewer change, or reset every viewer setting (camera, lights, '
            ...
            + 'a clean slate.',
        parameters: resetViewSettingsSchema
    })
    ...
    @ClientAITool({
        ...
        parameters: configureColorCodingSchema
    })
    ...
    @ClientAITool({
        ...
        parameters: pushExpressionSelectSchema
    })
    ...
    @ClientAITool({
        ...
        parameters: launchGrainSegmentationAnalysisSchema
    })
