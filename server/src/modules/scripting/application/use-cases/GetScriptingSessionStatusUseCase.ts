...
@Singleton()
export class GetScriptingSessionStatusUseCase implements IUseCase<GetScriptingSessionStatusInputDTO, GetScriptingSessionStatusOutputDTO> {
    constructor(
    ...
    async execute(input: GetScriptingSessionStatusInputDTO): Promise<GetScriptingSessionStatusOutputDTO> {
        if (!input.userId) {
