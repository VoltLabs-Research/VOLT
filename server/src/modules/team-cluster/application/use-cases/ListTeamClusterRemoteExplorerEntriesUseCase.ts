...
import { TeamClusterRemoteAccessTargetDTO, type TeamClusterRemoteExplorerEntryDTO } from '@modules/team-cluster/application/dtos/TeamClusterRemoteAccessDTO';
...
> {
    ...
    async execute(
        ...
        try {
            const entries = await this.teamClusterDaemonClient.command<TeamClusterRemoteExplorerEntryDTO[]>(
                input.teamClusterId,
