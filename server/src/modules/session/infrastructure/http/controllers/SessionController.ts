import type SessionService from '@modules/session/application/SessionService';
import type { GetActiveSessionsInputDTO } from '@modules/session/application/dtos/GetActiveSessionsDTO';
import type { GetLoginActivityInputDTO } from '@modules/session/application/dtos/GetLoginActivityDTO';
import type { RevokeAllSessionsInputDTO } from '@modules/session/application/dtos/RevokeAllSessionsDTO';
