...
import { teamScopedSocketPayloadSchema } from '@modules/socket/infrastructure/validation/team-subscription-schemas';
import TeamPresenceService, { DetachedTeamPresenceSession } from '@modules/team/application/services/team-member/TeamPresenceService';
