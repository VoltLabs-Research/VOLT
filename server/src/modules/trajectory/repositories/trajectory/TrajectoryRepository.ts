...
import Trajectory, { TrajectoryFrame, TrajectoryProps } from '@modules/trajectory/entities/trajectory/Trajectory';
import { ITrajectoryRepository } from '@modules/trajectory/ports/trajectory/ITrajectoryRepository';
import trajectoryMapper from '@modules/trajectory/mappers/trajectory/TrajectoryMapper';
import TrajectoryModel, { TrajectoryDocument } from '@modules/trajectory/models/trajectory/TrajectoryModel';
import TrajectoryFrameRepository from '@modules/trajectory/repositories/trajectory/TrajectoryFrameRepository';
