...
import { ISceneArtifactRepository, TeamSceneArtifactFilters } from '@modules/trajectory/ports/scene-artifacts/ISceneArtifactRepository';
import SceneArtifactMapper from '@modules/trajectory/mappers/scene-artifacts/SceneArtifactMapper';
