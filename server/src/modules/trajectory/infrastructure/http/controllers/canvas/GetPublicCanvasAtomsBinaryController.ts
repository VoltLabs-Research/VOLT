...
@injectable()
export default class GetPublicCanvasAtomsBinaryController {
    private readonly useCase: GetPublicCanvasAtomsUseCase;

    constructor() {
        this.useCase = container.resolve(GetPublicCanvasAtomsUseCase);
