...
export default createHttpModule({
    ...
    routes: (router) => {
        ...
        router.post('/:trajectoryId', RATE_LIMIT_POLICIES.particleFilterApply, particleFilterValidation.applyFilter, controllers.applyAction.handle);
        ...
        router.post(
            ...
            RATE_LIMIT_POLICIES.particleFilterApply,
