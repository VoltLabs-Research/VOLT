...
import { DefectMeshExportOptions, ProcessedMesh, Mesh, IMeshExporter } from '@modules/trajectory/domain/port/trajectory/exporters/MeshExporter';
...
export default class MeshExporter implements IMeshExporter{
    ...
    private async processMeshGeometry(mesh: Mesh, opts: Required<DefectMeshExportOptions>): Promise<ProcessedMesh> {
        ...
        if (opts.smoothIterations > 0) {
            nativeExporter.taubinSmooth(positions, indices, opts.smoothIterations);
        }
