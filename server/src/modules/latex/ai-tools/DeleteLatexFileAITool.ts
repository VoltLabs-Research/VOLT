...
export class DeleteLatexFileAITool extends AITool<Params> {
    ...
    async execute(params: Params, scope: AIToolScope) {
        return this.#service.deleteFile({ teamId: scope.teamId, documentId: params.documentId, fileId: params.fileId });
    }
}
