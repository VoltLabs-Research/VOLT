import type DashboardService from '@modules/dashboard/application/DashboardService';
import type { GetGlobalSearchInputDTO } from '@modules/dashboard/application/dtos/GetGlobalSearchDTO';
import { DASHBOARD_TOKENS } from '@modules/dashboard/infrastructure/di/DashboardTokens';
