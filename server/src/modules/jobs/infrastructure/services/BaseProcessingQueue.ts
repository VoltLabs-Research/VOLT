...
import { IWorkerPoolService, WorkerPoolConfig } from '@modules/jobs/domain/port/IWorkerPool';
...
import { IJobHandlerService, JobInfo } from '@modules/jobs/domain/port/IJobHandlerService';
