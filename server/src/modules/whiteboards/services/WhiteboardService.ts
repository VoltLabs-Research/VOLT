...
import type { CreateWhiteboardInputDTO, CreateWhiteboardOutputDTO } from '@modules/whiteboards/dtos/CreateWhiteboardDTO';
import type { DeleteWhiteboardInputDTO, DeleteWhiteboardOutputDTO } from '@modules/whiteboards/dtos/DeleteWhiteboardDTO';
import type { GetWhiteboardAssetInputDTO, GetWhiteboardAssetOutputDTO } from '@modules/whiteboards/dtos/GetWhiteboardAssetDTO';
import type { GetWhiteboardInputDTO, GetWhiteboardOutputDTO } from '@modules/whiteboards/dtos/GetWhiteboardDTO';
import type { GetWhiteboardStateInputDTO, GetWhiteboardStateOutputDTO } from '@modules/whiteboards/dtos/GetWhiteboardStateDTO';
import type { ListWhiteboardsInputDTO, ListWhiteboardsOutputDTO } from '@modules/whiteboards/dtos/ListWhiteboardsDTO';
import type { MoveWhiteboardInputDTO, MoveWhiteboardOutputDTO } from '@modules/whiteboards/dtos/MoveWhiteboardDTO';
import type { SaveWhiteboardStateInputDTO, SaveWhiteboardStateOutputDTO } from '@modules/whiteboards/dtos/SaveWhiteboardStateDTO';
import type { UpdateWhiteboardInputDTO, UpdateWhiteboardOutputDTO } from '@modules/whiteboards/dtos/UpdateWhiteboardDTO';
import type { UploadWhiteboardAssetInputDTO, UploadWhiteboardAssetOutputDTO } from '@modules/whiteboards/dtos/UploadWhiteboardAssetDTO';
...
import { UpdateWhiteboardUseCase } from '@modules/whiteboards/use-cases/UpdateWhiteboardUseCase';
import { requireWhiteboardStorageClusterId, type WhiteboardProps } from '@modules/whiteboards/entities/Whiteboard';
