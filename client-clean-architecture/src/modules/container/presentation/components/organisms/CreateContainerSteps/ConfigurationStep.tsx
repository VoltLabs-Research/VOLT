...
const ConfigurationStep = ({
    ...
    return (
        <Container className='create-container-step d-flex column gap-2'>
            ...
            <Container className='create-container-config-grid gap-1-5'>
                <Container className='create-container-config-section'>
                    <Container className='create-container-config-section-header'>
                ...
                <Container className='create-container-config-section full-width'>
                    ...
                    <Container className='create-container-resource-row p-1'>
                        <Container className='d-flex content-between items-center create-container-resource-header'>
                            <span className='d-flex items-center gap-05 font-size-2 font-weight-5 color-secondary'>
                                <Cpu size={16} /> CPU Cores
                            </span>
                            <span className='create-container-resource-value font-weight-6'>{config.cpus} vCPU</span>
                        </Container>
                        <Slider
                            min={0.5}
                            max={MAX_CPU}
                    ...
                    <Container className='create-container-resource-row p-1'>
                        <Container className='d-flex content-between items-center create-container-resource-header'>
                            ...
                            <span className='create-container-resource-value font-weight-6'>{config.memory} MB</span>
                        </Container>
                        <Slider
                            min={128}
                            max={MAX_MEMORY}
                ...
                <Container className='create-container-config-card d-flex column gap-05 p-1-5'>
                    <FormField
                        variant='inline'
                        fieldType='checkbox'
            ...
            <Container className='d-flex content-end gap-1 create-container-step-actions'>
