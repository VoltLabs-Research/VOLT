...
import { ORTHOGRAPHIC_DEFAULT, PERSPECTIVE_DEFAULT, type CameraSettingsState, type CameraSettingsStore } from '@/modules/canvas/presentation/types/stores/editor/camera-config';
