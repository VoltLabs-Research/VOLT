...
import type { EnvironmentConfigStore } from '@/modules/canvas/presentation/types/stores/editor/environment-config';
import { ENVIRONMENT_DEFAULT_CONFIG } from '@/modules/canvas/presentation/types/stores/editor/environment-config';
