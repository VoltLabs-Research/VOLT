...
import type { EffectsConfigStore, EffectsConfigState } from '@/modules/canvas/presentation/types/stores/editor/effects-config';
import {
    SSAO_EFFECT_DEFAULT,
    ...
    NOISE_DEFAULT,
    SEPIA_DEFAULT
} from '@/modules/canvas/presentation/types/stores/editor/effects-config';
