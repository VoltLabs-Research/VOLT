...
import vertexShader from '@/modules/canvas/presentation/assets/shaders/point-cloud.vert?raw';
import fragmentShader from '@/modules/canvas/presentation/assets/shaders/point-cloud.frag?raw';
import { getOptimizedMaterial } from '@/modules/canvas/presentation/utilities/modelUtils';
