...
} from '@shared/infrastructure/runtime/execution-log-streaming';
import {
...
interface DebugExecutionLogReporter {
    reportDebugLogChunk(
        input: import('@shared/contracts/channel/reverse-channel-analysis').DebugLogChunkPayload
    ): Promise<void>;
}

interface DebugSessionRequest {
    workflow: import('@shared/contracts/types/http-workflow').WorkflowDefinition;
    nestedPlugins: import('@shared/contracts/types/http-workflow').NestedPluginDefinition[];
    trajectoryId: string;
    trajectoryFrames: import('@shared/contracts/types/http-workflow').TrajectoryFrame[];
    pluginId: string;
    teamId: string;
...
interface DebugNodeResult {
    ...
    output?: import('@shared/contracts/types/workflow.types').WorkflowNodeOutput;
    error?: string;
    stack?: string;
    reason?: string;
    nestedTrace?: import('@modules/analysis/services/workflow/WorkflowRuntime').InlineWorkflowTraceNode[];
    durationMs: number;
...
interface DebugSession {
    sessionId: string;
    context: import('@shared/contracts/types/workflow.types').WorkflowExecutionContext;
    executableNodes: import('@shared/contracts/types/workflow.types').WorkflowNode[];
    nodeById: Map<string, import('@shared/contracts/types/workflow.types').WorkflowNode>;
    ...
    exposuresByNodeId: Map<string, import('@shared/contracts/types/http-analysis').AnalysisExposureDefinition>;
...
export class DebugSessionManager {
    ...
    constructor(
        workflowNodeRegistry: import('@modules/analysis/services/workflow/NodeRegistry').WorkflowNodeRegistry,
        private readonly debugEnvironment: import('@modules/analysis/services/workflow/debug/DebugEnvironment').DebugEnvironment,
    ...
    createSession(request: DebugSessionRequest): DebugSessionInfo {
        ...
        const stubAnalysis: import('@shared/contracts/types/http-analysis').DaemonAnalysisDocument = {
