...
import { WorkflowEngine, type WorkflowExecutionRequest } from '@modules/analysis/services/workflow/WorkflowEngine';
import { WorkflowNodeRegistry } from '@modules/analysis/services/workflow/NodeRegistry';
import { WorkflowNodeType } from '@shared/contracts/types/workflow.types';
import type { TrajectoryDumpDescriptor, TrajectoryFrame, WorkflowDefinition } from '@shared/contracts/types/http-workflow';
