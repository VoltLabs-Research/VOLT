...
import { PipelineSharedExposureStore } from '@/modules/analysis/application/analysis/PipelineSharedExposureStore';
import type { ClusterObjectStore } from '@/core/storage/application/ClusterObjectStore';

// Two structure-identification exposures (clusters_table, clusters_transitions)
// persist under distinct `shared-<id>/` prefixes but share the basename
// `timestep-N.table`. fetch() must not let the second clobber the first.
