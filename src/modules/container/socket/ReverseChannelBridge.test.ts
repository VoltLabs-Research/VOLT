...
import { encodeEnvelope, EnvelopeKind } from '@shared/contracts/channel/binary-envelope';
import { ReverseChannelBridge } from '@modules/container/socket/ReverseChannelBridge';
