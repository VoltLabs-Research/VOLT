...
import { exportOctreeMetadata, buildOctreeMetadataSidecarKey } from '@modules/plugin/services/exports/octree-exporter';
import type { ExportExecutionInput } from '@modules/plugin/services/exports/export-node-processor-types';
import type { OctreeMetadata } from '@shared/domain/octree';
