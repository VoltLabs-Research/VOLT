...
const MODULE_MANIFESTS = [
    defineModule({
        key: 'system',
        tier: 'kernel',
        description: 'Runtime role, metrics and heartbeat plane'
    }),
    defineModule({
        key: 'container',
        tier: 'kernel',
        description: 'Cloud connections, reverse channel, docker runtime access'
    }),

    defineModule({
        key: 'jobs',
        tier: 'capability',
        optional: ['analysis', 'plugin', 'trajectory'],
        description: 'Queue job control and status reporting'
    }),
    ...
    defineModule({
        ...
        requires: ['jobs'],
        optional: ['analysis'],
        description: 'Plugin binaries, exports and property stores'
    }),
    defineModule({
        key: 'trajectory',
        tier: 'compute',
        requires: ['jobs', 'plugin'],
        optional: ['analysis'],
        description: 'Trajectory parsing, framing, raster and glb'
    }),
    defineModule({
        key: 'analysis',
        tier: 'compute',
        requires: ['jobs', 'plugin', 'trajectory'],
        description: 'Analysis and pipeline workflow execution'
    }),
