...
import type { ScriptingNotebookDocument } from './LocalMongoService';
...
export class JupyterRuntimeService {
    constructor(
        ...
        private readonly dockerAssetsPath: string
    ) {
    }
    ...
    async initialize(): Promise<void> {
        try {
            ...
            await this.dockerRuntimeService.buildImage(this.config.jupyter.image, this.dockerAssetsPath);
        }
    }
